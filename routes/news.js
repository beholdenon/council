...
router.get('/', function(req, res, next) {
	...
	res.render('news', { 'news': req.news, 'url': absoluteRoot + req.url, 'image': absoluteRoot + '/images/og-image.jpg', 'title': 'News - Re-Elect Robert Holden For City Council - District 30' });
});
